...
static char *font2[] = {"feather:pixelsize=20", "Material Design Icons Desktop:style=Regular:pixelsize=20", "JoyPixels:pixelsize=18:antialias=true:autohint=true", };
...
#define TRMMOD (ControlMask|ShiftMask)
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,               XK_Up,           externalpipe,   {.v = copyoutput } },
};
